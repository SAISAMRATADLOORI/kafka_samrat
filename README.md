...
java -cp target/kafka_samrat-1.0-SNAPSHOT-jar-with-dependencies.jar edu.northwest.samrat.CustomConsumer
```
...
java -cp target/kafka_samrat-1.0-SNAPSHOT-jar-with-dependencies.jar edu.northwest.samrat.CustomProducer
```
